...
// ── Layout grids (for onboarding markets that have been configured) ────────

const GRID_LAYOUT_1: Record<string, any> = {
  '0-0': { type: 'entry', facing: 'S' },
  '0-1': { type: 'road', facing: 'S' },
  '0-2': { type: 'road', facing: 'S' },
  '0-3': { type: 'road', facing: 'S' },
  '0-4': { type: 'road', facing: 'S' },
  '0-5': { type: 'road', facing: 'S' },
  '0-6': { type: 'road', facing: 'S' },
  '0-7': { type: 'road', facing: 'S' },
  '0-8': { type: 'road', facing: 'S' },
  '0-9': { type: 'entry', facing: 'S' },
  '1-0': { type: 'stall', catId: 'flowers', facing: 'S' },
  '1-1': { type: 'stall', catId: 'flowers', facing: 'S' },
  '1-2': { type: 'stall', catId: 'leafy', facing: 'S' },
  '1-3': { type: 'stall', catId: 'leafy', facing: 'S' },
  '1-4': { type: 'stall', catId: 'leafy', facing: 'S' },
  '1-5': { type: 'stall', catId: 'fruits', facing: 'S' },
  '1-6': { type: 'stall', catId: 'fruits', facing: 'S' },
  '1-7': { type: 'stall', catId: 'fruits', facing: 'S' },
  '1-8': { type: 'stall', catId: 'snacks', facing: 'S' },
  '1-9': { type: 'stall', catId: 'snacks', facing: 'S' },
  '2-0': { type: 'pathway', facing: 'S' },
  '2-1': { type: 'pathway', facing: 'S' },
  '2-2': { type: 'pathway', facing: 'S' },
  '2-3': { type: 'pathway', facing: 'S' },
  '2-4': { type: 'pathway', facing: 'S' },
  '2-5': { type: 'pathway', facing: 'S' },
  '2-6': { type: 'pathway', facing: 'S' },
  '2-7': { type: 'pathway', facing: 'S' },
  '2-8': { type: 'pathway', facing: 'S' },
  '2-9': { type: 'pathway', facing: 'S' },
  '3-0': { type: 'stall', catId: 'tarkari', facing: 'N' },
  '3-1': { type: 'stall', catId: 'tarkari', facing: 'N' },
  '3-2': { type: 'stall', catId: 'tarkari', facing: 'N' },
  '3-3': { type: 'stall', catId: 'onion-pot', facing: 'N' },
  '3-4': { type: 'stall', catId: 'onion-pot', facing: 'N' },
  '3-5': { type: 'stall', catId: 'spices', facing: 'N' },
  '3-6': { type: 'stall', catId: 'spices', facing: 'N' },
  '3-7': { type: 'stall', catId: 'dairy', facing: 'N' },
  '3-8': { type: 'stall', catId: 'dairy', facing: 'N' },
  '3-9': { type: 'stall', catId: 'general', facing: 'N' },
  '4-0': { type: 'stall', catId: 'tarkari', facing: 'S' },
  '4-1': { type: 'stall', catId: 'flwr-kobi', facing: 'S' },
  '4-2': { type: 'stall', catId: 'flwr-kobi', facing: 'S' },
  '4-3': { type: 'stall', catId: 'dryfruits', facing: 'S' },
  '4-4': { type: 'stall', catId: 'dryfruits', facing: 'S' },
  '4-5': { type: 'stall', catId: 'seasonal', facing: 'S' },
  '4-6': { type: 'stall', catId: 'seasonal', facing: 'S' },
  '4-7': { type: 'stall', catId: 'exotics', facing: 'S' },
  '4-8': { type: 'stall', catId: 'bakery', facing: 'S' },
  '4-9': { type: 'stall', catId: 'bakery', facing: 'S' },
  '5-0': { type: 'pathway', facing: 'S' },
  '5-1': { type: 'pathway', facing: 'S' },
  '5-2': { type: 'pathway', facing: 'S' },
  '5-3': { type: 'pathway', facing: 'S' },
  '5-4': { type: 'pathway', facing: 'S' },
  '5-5': { type: 'pathway', facing: 'S' },
  '5-6': { type: 'pathway', facing: 'S' },
  '5-7': { type: 'pathway', facing: 'S' },
  '5-8': { type: 'pathway', facing: 'S' },
  '5-9': { type: 'pathway', facing: 'S' },
  '6-0': { type: 'stall', catId: 'mukhvas', facing: 'N' },
  '6-1': { type: 'stall', catId: 'mukhvas', facing: 'N' },
  '6-2': { type: 'stall', catId: 'gajar-wat', facing: 'N' },
  '6-3': { type: 'stall', catId: 'gajar-wat', facing: 'N' },
  '6-4': { type: 'stall', catId: 'pineapple', facing: 'N' },
  '6-5': { type: 'stall', catId: 'pineapple', facing: 'N' },
  '6-6': { type: 'stall', catId: 'antique', facing: 'N' },
  '6-7': { type: 'stall', catId: 'other', facing: 'N' },
  '7-0': { type: 'parking', facing: 'S' },
  '7-1': { type: 'parking', facing: 'S' },
  '7-2': { type: 'parking', facing: 'S' },
  '7-3': { type: 'parking', facing: 'S' },
  '7-4': { type: 'parking', facing: 'S' },
  '7-5': { type: 'parking', facing: 'S' },
  '7-6': { type: 'parking', facing: 'S' },
  '7-7': { type: 'parking', facing: 'S' },
};

const STALL_RENTS_1: Record<string, number> = {
  '1-0': 150, '1-1': 150, '1-2': 120, '1-3': 120, '1-4': 120,
  '1-5': 180, '1-6': 180, '1-7': 180, '1-8': 200, '1-9': 200,
  '3-0': 120, '3-1': 120, '3-2': 120, '3-3': 100, '3-4': 100,
  '3-5': 130, '3-6': 130, '3-7': 140, '3-8': 140, '3-9': 110,
  '4-0': 120, '4-1': 125, '4-2': 125, '4-3': 160, '4-4': 160,
  '4-5': 135, '4-6': 135, '4-7': 200, '4-8': 150, '4-9': 150,
  '6-0': 110, '6-1': 110, '6-2': 115, '6-3': 115, '6-4': 130,
  '6-5': 130, '6-6': 170, '6-7': 100,
};

const GRID_LAYOUT_2: Record<string, any> = {
  '0-0': { type: 'entry', facing: 'S' },
  '0-1': { type: 'road', facing: 'S' },
  '0-2': { type: 'road', facing: 'S' },
  '0-3': { type: 'road', facing: 'S' },
  '0-4': { type: 'road', facing: 'S' },
  '0-5': { type: 'entry', facing: 'S' },
  '1-0': { type: 'stall', catId: 'flowers', facing: 'S' },
  '1-1': { type: 'stall', catId: 'leafy', facing: 'S' },
  '1-2': { type: 'stall', catId: 'fruits', facing: 'S' },
  '1-3': { type: 'stall', catId: 'tarkari', facing: 'S' },
  '1-4': { type: 'stall', catId: 'onion-pot', facing: 'S' },
  '1-5': { type: 'stall', catId: 'spices', facing: 'S' },
  '2-0': { type: 'pathway', facing: 'S' },
  '2-1': { type: 'pathway', facing: 'S' },
  '2-2': { type: 'pathway', facing: 'S' },
  '2-3': { type: 'pathway', facing: 'S' },
  '2-4': { type: 'pathway', facing: 'S' },
  '2-5': { type: 'pathway', facing: 'S' },
  '3-0': { type: 'stall', catId: 'dairy', facing: 'N' },
  '3-1': { type: 'stall', catId: 'snacks', facing: 'N' },
  '3-2': { type: 'stall', catId: 'dryfruits', facing: 'N' },
  '3-3': { type: 'stall', catId: 'bakery', facing: 'N' },
  '3-4': { type: 'stall', catId: 'general', facing: 'N' },
  '3-5': { type: 'stall', catId: 'seasonal', facing: 'N' },
  '4-0': { type: 'parking', facing: 'S' },
  '4-1': { type: 'parking', facing: 'S' },
  '4-2': { type: 'parking', facing: 'S' },
  '4-3': { type: 'parking', facing: 'S' },
  '4-4': { type: 'parking', facing: 'S' },
  '4-5': { type: 'parking', facing: 'S' },
};

const STALL_RENTS_2: Record<string, number> = {
  '1-0': 200, '1-1': 150, '1-2': 250, '1-3': 130, '1-4': 100, '1-5': 180,
  '3-0': 175, '3-1': 220, '3-2': 300, '3-3': 190, '3-4': 120, '3-5': 160,
};

// ── Onboardings ───────────────────────────────────────────────────────────────

export const ONBOARDINGS: Onboarding[] = [
  { id: 'WIN-037', marketName: 'Vidya Vikas Market', marketAddress: '103, Market Nagar, Madhav Nagar, Tilke Colony, Nashik', pinCode: '422010', marketType: 'Farmer Market', category: 'Premium Class', households: 100, ownershipType: 'Private', docType: 'Agreement', operatingDays: 'Sun', operatingTime: '10:00 – 02:00 PM', numberOfOutlets: 100, managerId: 'u8', bondingMethod: 'Fixed Rent', rentPerOutletPerWeek: 100000, status: 'Approved', createdBy: 'u8', createdAt: d(15), updatedAt: d(3), layoutGrid: GRID_LAYOUT_1, layoutRows: 8, layoutCols: 10, stallRents: STALL_RENTS_1 },
  { id: 'WIN-038', marketName: 'New Market', marketAddress: 'G2K1+H8, Mumbai Hata, Madhav Nagar, Nashik', pinCode: '470052', marketType: 'Sakhi Market', category: 'Middle Class', households: 0, ownershipType: 'Private', docType: 'Permission Letter', operatingDays: 'Sun–Sat', operatingTime: 'All Day', numberOfOutlets: 44, managerId: 'u9', bondingMethod: 'Fixed Rent', rentPerOutletPerWeek: 30800, status: 'Approved', createdBy: 'u9', createdAt: d(14), updatedAt: d(2), layoutGrid: GRID_LAYOUT_2, layoutRows: 5, layoutCols: 6, stallRents: STALL_RENTS_2 },
